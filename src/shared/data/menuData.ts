...
export const menuItems: MenuItem[] = [
  // 커피
  {
    ...
    category: 'coffee',
    price: 4500,
    image: '/src/assets/menu_images/cafemoca.png',
    description: '진한 에스프레소와 초콜릿, 우유가 만나 만든 달콤한 커피',
    descriptionEn: 'Rich espresso combined with chocolate and milk for a sweet coffee experience',
    isAvailable: true,
    temperature: 'hot',
    size: 'medium',
    calories: 250
  ...
  // 차류
  {
    ...
    category: 'tea',
    price: 3500,
    image: '/src/assets/menu_images/Chamomile_tea.png',
  ...
  },
  {
    ...
    category: 'tea',
    price: 4000,
    image: '/src/assets/menu_images/peach_tea.png',
  ...
  },
  {
    ...
    category: 'tea',
    price: 3500,
    image: '/src/assets/menu_images/peppermint_tea.png',
  ...
  // 주스류
  {
    ...
    category: 'juice',
    price: 5000,
    image: '/src/assets/menu_images/kiwi_juice.png',
  ...
  // 에이드류
  {
    ...
    category: 'ade',
    price: 4500,
    image: '/src/assets/menu_images/grapefruit_ade.png',
  ...
  },
  {
    ...
    category: 'ade',
    price: 4500,
    image: '/src/assets/menu_images/mango_ade.png',
  ...
  // 디저트
  {
    ...
    category: 'dessert',
    price: 6000,
    image: '/src/assets/menu_images/basic_wafle.png',
  ...
  },
  {
    ...
    category: 'dessert',
    price: 7000,
    image: '/src/assets/menu_images/cookie_wafle.png',
  ...
  },
  {
    ...
    category: 'dessert',
    price: 5500,
    image: '/src/assets/menu_images/cream_rollcake.png',
